...
public:
	...
	void update(PhysicsComponent &a, std::vector<std::shared_ptr<PhysicsComponent>> &phyComps, double dt);

	bool checkIfCollide(PhysicsComponent &a, PhysicsComponent& b, double dt);

	void resolveCollision(std::shared_ptr<PhysicsComponent> a, std::shared_ptr<PhysicsComponent> b , double dt);
