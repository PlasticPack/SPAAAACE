...
<<<<<<< HEAD
						postman.addMessage("HUD", "FUEL", MS_FUEL_LEVEL, (double)(m_gameObjects["player"]->get<GameLogicComponent>()->getCurrentFuel()) / (double)m_gameObjects["player"]->get<GameLogicComponent>()->getMaxFuel());
