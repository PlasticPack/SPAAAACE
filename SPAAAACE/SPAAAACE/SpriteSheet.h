...
public:
	SpriteSheet();
	SpriteSheet(SDL_Texture* texture, std::string filename, int nbcol = 1, int nbrow = 1);
	SpriteSheet(SDL_Texture* texture, std::string filename, SDL_Rect rectSize, SDL_Rect);
